...
<form name="form1" class="col-sm-4" action="dsifreunutara2.php" method="POST" onsubmit="(return formkontrol())" style="margin-top:250px; margin-left:15px; float:left;">
    ...
    <input type="text"  name="tel_kod"  class="form-control mb-4" placeholder="Telefonunuza Gelen Kodu Giriniz"><br>
     <input type="text"  name="doktor_tc"  class="form-control mb-4" readonly value="<?php echo $temptc; ?>"><br>
