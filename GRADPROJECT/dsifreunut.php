...
<form class="col-sm-4" action="dsifreunutara.php" method="POST" style="margin-top:250px; margin-left:15px; float:left;">

    <p class="h4 mb-4">ŞİFRE YENİLEME</p>
    <input type="text"  name="doktor_tc"  class="form-control mb-4" placeholder="TC Kimlik Numaranızı Giriniz"><br>
