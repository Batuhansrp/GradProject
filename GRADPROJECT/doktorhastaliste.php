...
<meta name="keywords" content="<?php echo $SiteKeywords; ?>">
        ...
        <section class="module">
            <div class="module-inner">
                ...
                <div   class="content-panel">
                  <table class="table" class="col-sm-8 col-lg-10">
  <thead class="thead-dark">
    <tr>
    <th scope="col">Hasta TC</th>
      <th scope="col">Hasta Adı</th>
      <th scope="col">Hasta Soyadı</th>
      <th scope="col">Hasta İlaç Türü</th>
      <th scope="col">Hasta Diyabet Türü</th>
      <th scope="col">Hasta Ölçümü</th>
    </tr>
  </thead>
  <tbody>
 ...
 FROM DOKTOR INNER JOIN HASTA ON DOKTOR.doktor_tc=HASTA.doktor_id where doktor_tc=$temp"); 
  $goruntule->execute();
  
  while ($vericekme=$goruntule->fetch(PDO ::FETCH_ASSOC) ){ ?>
  
    <tr>
      <td><?php echo $vericekme['hasta_tc'] ?></td>    
      <td><?php echo $vericekme['hasta_ad'] ?></td>
      <td><?php echo $vericekme['hasta_soyad'] ?></td>
      <td><?php echo $vericekme['hasta_ilactur'] ?></td>
      <td><?php echo $vericekme['hasta_diyabettur'] ?></td> 
      <td><a href="dhastaolcumgorme.php?hasta_tc=<?php echo $vericekme['hasta_tc']?>"><button type="submit" name="dolcumliste">Ölçüme Git</button></td>
    </tr>
   <?php
      }
      ?>
